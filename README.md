...
AutoDoc is a simple tool based on OpenAI (requiring an OpenAI account, a valid API key, and available credit) designed to automatically generate detailed and structured documentation for your c++ codebase. Input is a list of folders that you want to be analyzed and the output is a README file.
